...
export const AuthorSection: React.FC = () => {
  return (
    <section id="author" className="py-10 sm:py-14 bg-[#DE5541] text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-bebas text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#10F4A0] leading-[0.95] tracking-tight">
              THE AUTHOR
              <br />
              DR ANAND KULKARNI
            </h2>
          ...
          >
            <div className="relative group max-w-sm sm:max-w-md w-full">
              {/* Photo Container - Clean without square border */}
              <div className="relative rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="p-4 bg-white text-[#1E293B] flex items-center justify-between">
                  <div>
