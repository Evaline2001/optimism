...
import bookCover from '../assets/images/book_cover_3d.png';
      ...
      >
        ...
        <div className="relative select-none">
          <img
            ...
            className="w-full h-auto object-contain block select-none drop-shadow-[0_20px_35px_rgba(28,15,60,0.3)] group-hover:drop-shadow-[0_28px_45px_rgba(28,15,60,0.4)] transition-all duration-300"
