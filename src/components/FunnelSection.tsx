...
export const FunnelSection: React.FC = () => {
  ...
  const tiers = [
    {
      ...
      title: 'Foundations',
      description:
        "Peace, governance and solidarity are threshold conditions. They don't need to be perfect — but they must show credible progress.",
    },
    {
  ...
  return (
    <section id="funnel" className="py-10 sm:py-14 bg-[#E01A8A] text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Section Headline matching Home.png */}
        <div className="text-left mb-8 sm:mb-10 max-w-4xl">
          <h2 className="font-bebas text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[0.95] tracking-tight text-white">
            <AnimatedText text="THE FUNNEL OF OPTIMISM" className="inline-block" />
          </h2>
          
          <div className="mt-4 text-white/95">
            <p className="text-sm sm:text-base md:text-lg font-normal leading-relaxed text-white/90">
              Optimism, here, isn&apos;t rhetoric — it&apos;s structural. Peace, governance and solidarity form the foundations. A young population, entrepreneurs, technology, the diaspora and creative industries build the capabilities. Together they produce the outcomes: higher growth, rising incomes, falling poverty. Foundations enable capabilities. Capabilities generate outcomes. Outcomes strengthen optimism — and the cycle compounds.
            </p>
          </div>
        </div>

        {/* Slogan Banner matching Home.png */}
        <div className="text-center mb-8 sm:mb-12">
          <motion.div
            ...
            className="inline-flex items-center gap-2 sm:gap-3 px-6 py-2 rounded-full bg-white/15 border border-white/30 text-white text-sm sm:text-base md:text-lg font-medium tracking-normal shadow-sm backdrop-blur-xs"
          >
        ...
        <div className="border-t border-white/30 pt-10 mt-6">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/25">
            {tiers.map((tier, idx) => (
              ...
              >
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-normal mb-2 leading-tight flex items-center justify-between">
