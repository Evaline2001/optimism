...
export const GetTheBookSection: React.FC = () => {
  ...
  return (
    <section id="get-book" className="py-10 sm:py-14 bg-[#FFFDF9] border-t border-[#F0EBE1]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="font-bebas text-3xl sm:text-4xl lg:text-5xl text-[#00A86B] leading-[0.95] tracking-tight">
