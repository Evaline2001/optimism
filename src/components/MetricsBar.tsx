...
export const MetricsBar: React.FC = () => {
  ...
  return (
    <section className="bg-[#00BFA5] text-white py-6 sm:py-7 border-y border-[#009688]/30 shadow-inner relative transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0 lg:divide-x lg:divide-white/30">
