...
export const PartnersSection: React.FC = () => {
  return (
    <section id="partners" className="py-16 sm:py-24 bg-[#FBF8F2] border-t border-[#EAE3D2] relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-bebas text-3xl sm:text-4xl lg:text-5xl text-[#4A154B] leading-[0.95] tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            whileHover={{
              y: -5,
              scale: 1.01,
              boxShadow: '0 20px 40px -16px rgba(200, 100, 20, 0.16)',
            }}
            className="rounded-2xl p-6 sm:p-8 bg-white border border-[#E2D8C9] hover:border-[#C86414]/30 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between group"
          >
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-bebas text-2xl sm:text-3xl text-[#C86414] tracking-tight">
            ...
            <div className="pt-5 mt-5 border-t border-slate-100">
              <motion.a
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-full bg-[#C86414] hover:bg-[#A9510C] text-white font-bold text-xs sm:text-sm uppercase tracking-wider shadow-sm hover:shadow transition-colors inline-flex items-center justify-center gap-2 min-h-[42px]"
              >
          ...
          <motion.div
            ...
            whileHover={{
              y: -5,
              scale: 1.01,
              boxShadow: '0 20px 40px -16px rgba(14, 74, 110, 0.16)',
            }}
            className="rounded-2xl p-6 sm:p-8 bg-white border border-[#E2D8C9] hover:border-[#0284C7]/30 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between group"
          >
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-bebas text-2xl sm:text-3xl text-[#1565C0] tracking-tight">
            ...
            <div className="pt-5 mt-5 border-t border-slate-100">
              <motion.a
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-full bg-[#1565C0] hover:bg-[#0D47A1] text-white font-bold text-xs sm:text-sm uppercase tracking-wider shadow-sm hover:shadow transition-colors inline-flex items-center justify-center gap-2 min-h-[42px]"
              >
