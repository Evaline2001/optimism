...
export const QuizSection: React.FC<QuizSectionProps> = ({ onOpenGetBook }) => {
  ...
  return (
    <section id="quiz" className="py-10 sm:py-14 bg-[#FFFDF9] border-t border-[#F0EBE1]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-8">
          <div className="lg:col-span-7 space-y-2">
            ...
            <h2 className="font-bebas text-3xl sm:text-4xl md:text-5xl text-[#1E293B] leading-[0.95] tracking-tight">
          ...
          <div className="lg:col-span-5 space-y-3.5">
            <p className="text-xs sm:text-sm text-[#64748B] leading-relaxed">
              Inspired by Hans Rosling&apos;s Factfulness: most people score worse than random guessing on questions like these — because our instincts lag decades behind the data. Thirty questions, pulled from every chapter of the book, each with a short explanation after you answer.
            </p>
            {/* Category Pills matching exact reference styling in one single line */}
            <div className="flex flex-nowrap items-center gap-2 sm:gap-2.5 pt-0.5 overflow-x-auto">
              <span
                className="px-3.5 sm:px-4 py-1.5 rounded-full text-xs sm:text-sm font-medium tracking-normal text-[#00D2FF] bg-[#7D1BA1] shadow-xs cursor-default select-none transition-transform hover:scale-105 whitespace-nowrap shrink-0"
              >
                Foundations
              </span>
              <span
                className="px-3.5 sm:px-4 py-1.5 rounded-full text-xs sm:text-sm font-medium tracking-normal text-[#ACE111] bg-[#EA635A] shadow-xs cursor-default select-none transition-transform hover:scale-105 whitespace-nowrap shrink-0"
              >
                Capabilities
              </span>
              <span
                className="px-3.5 sm:px-4 py-1.5 rounded-full text-xs sm:text-sm font-medium tracking-normal text-[#FBDFE9] bg-[#E532CA] shadow-xs cursor-default select-none transition-transform hover:scale-105 whitespace-nowrap shrink-0"
              >
                Outcomes
              </span>
            </div>
        ...
        {/* Main Quiz Box - Sleek, single unified card */}
        <div id="quiz-box" className="rounded-2xl bg-[#1D4ED8] text-white p-6 sm:p-8 lg:p-10 shadow-xl overflow-hidden relative">
          ...
          {!isQuizActive ? (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
              ...
              <div className="lg:col-span-8 space-y-4 sm:space-y-5">
                <span className="inline-block text-xs sm:text-sm font-bold tracking-widest text-[#67E8F9] uppercase cursor-default">
                  BEFORE YOU BEGIN
                </span>

                <h3 className="font-bebas text-3xl sm:text-5xl md:text-6xl text-white leading-[0.95] tracking-tight">
                  TAKE A GUESS BEFORE
                  <br />
                  YOU TAKE THE FACTS.
                </h3>
                ...
                <div className="pt-2">
                  <button
                    id="start-quiz-btn"
                    onClick={handleStart}
                    className="px-7 py-3 rounded-full bg-[#E01A8A] hover:bg-[#C2185B] text-white font-bold text-sm sm:text-base tracking-wide transition-all shadow-md hover:shadow-lg active:scale-95 cursor-pointer uppercase inline-flex items-center gap-2"
                  >
              ...
              <div className="lg:col-span-4 flex justify-center lg:justify-end">
                <div className="relative flex items-center justify-center">
                  <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-full border-4 border-[#A3E635] p-1 flex items-center justify-center shadow-lg shadow-[#A3E635]/20">
                    <div className="w-full h-full rounded-full border-2 border-[#A3E635]/60 bg-blue-900/50 flex flex-col items-center justify-center text-center p-3">
