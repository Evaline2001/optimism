...
export const ReviewsSection: React.FC = () => {
  ...
  return (
    <section id="reviews" className="py-16 sm:py-24 bg-[#FFFDF9] border-t border-[#F0EBE1]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-2xl bg-white border border-[#E2D8C9] p-6 sm:p-8 shadow-md mb-12 text-left relative overflow-hidden">
              ...
              <AnimatePresence>
                {reviews.map((rev) => (
                  <motion.div
                    ...
                    className="rounded-2xl p-5 sm:p-6 bg-white border border-[#E2D8C9] hover:border-amber-400/40 shadow-xs hover:shadow-md transition-all flex flex-col justify-between"
                  >
                    <div>
